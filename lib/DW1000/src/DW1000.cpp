// minor mods by sjr 1/18/2022 see https://github.com/Makerfabs/Makerfabs-ESP32-UWB
// last update 5/30/22 line 650 doubled TX_POWER to 0x28
/*
...
constexpr byte DW1000Class::MODE_LONGDATA_RANGE_LOWPOWER[];  //preferred for range (sjr)
...
//				writeValueToBytes(txpower, 0x48484848L, LEN_TX_POWER);   //LONGDATA_RANGE_LOWPOWER 0X48=12 dB, 4 dB
				writeValueToBytes(txpower, 0x28282828L, LEN_TX_POWER);   //LONGDATA_RANGE_LOWPOWER 0X28=15 dB, 4 dB
			}
		} else if(_pulseFrequency == TX_PULSE_FREQ_64MHZ) {
			if(_smartPower) {
...
// ***allocate at least 100 characters for msgBuffer!***
